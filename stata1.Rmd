...
**Helpful Chapters on Stata**

You can access the Daniels & Minot textbook through Syracuse University's online library with this [link](https://research-ebsco-com.libezproxy2.syr.edu/c/gvriom/search/details/qcsbnwmqtn?db=nlebk).


1. Daniels & Minot, Ch. 4: An Introduction to Stata, p. 43--47, bottom 53--top 54
2. Daniels & Minot, Ch. 4, Section 4.5 Using Log Files and Saving Your Work
3. Daniels & Minot, Ch. 5, Section 5.1: Cleaning Data
4. Daniels & Minot, Ch. 5, Section 5.2: Checking for Outliers
5. Daniels & Minot, Ch. 5, Section 5.3: Creating New Variables
6. [Stata Manual & Notre Dame Hesbergh Library](https://www.stata.com/manuals/u23.pdf): Combining datasets
7. Daniels & Minot, pp. 75-90 and 96-101: Descriptive Statistics

In ECN 310, you will do a short reading before each class (often from the aforementioned texts), and you will be asked to complete a reading quiz on Blackboard. But, you get to know the exact questions that will be on the quiz! This is because Professor Buzard gives you a "quiz prep" document on Blackboard that contains each of the questions, so you can mark down the answers as you read. For your first class, you will be asked to read part of [Chapter 1 of Greenlaw](greenlaw_ch1.pdf) and of [Chapter 1 of Remler & Van Ryzin](remler&vanryzin_ch1.pdf). You can reference the first class [quiz prep document](ecn310_class1_quizprep.pdf).