...
If you want to learn more about how we use Stata and what we use it for, you can refer to the links and textbook sections below. These include helpful information on Stata basics, how to save your work, and how to view, edit, and analyze data. We encourage you to follow along with the exercises given in the book (then we also need instructions on how to get the datasets, which may be too complicated to get up and running for tomorrow.)

^ Can I link to PDFs of some of these sections in here? Also, where would you like the portion on quiz prep? Referenced somewhere in here with the textbooks or in its own section?

**Sections from GitHub:**

- Sept 10: Daniels & Minot, Ch. 4: An Introduction to Stata, p. 43--47, bottom 53--top 54
E book available at: first link pasted (DID NOT WORK ANYMORE ON 7/17/25; TRY second link pasted)
- Oct 1: Daniels & Minot, Ch. 4, Section 4.5 Using Log Files and Saving Your Work; Daniels & Minot, Ch. 5, Sections 5.1 and 5.2 Cleaning Data and Checking for Outliers,
- Oct 22: Creating New Variables, Daniels & Minot Section 5.3
- Oct 24: Combining datasets (Stata Manual & Notre Dame Hesbergh Library)
- Oct 29: Descriptive Statistics, Daniels & Minot, pp. 75-80 and 96-101
- Nov 5: Descriptive Statistics, Daniels & Minot, pp. 81-90


kbuzard@gmail.com I will copy and paste the links for when I am making the actual files that will be sent out. Also, in the exercise, I just focused on some of the basics of how Stata interacts with data. Do you want something that is saveable, like working with a do file or log file? If so, I will fill in the purple text at the end of Stata Exercise.
