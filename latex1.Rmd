...
<img src="latex_sandbox.png" style="border: 1px solid black; border-radius: 8px; box-shadow: 2px 2px 6px #888; max-width: 100%;" alt="LaTeX Sandbox Screenshot">


## Join and Experiment with Overleaf
